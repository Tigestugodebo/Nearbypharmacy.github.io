...
<div class="topnav" id="myTopnav">
  ...
  <a href="medicine_list.php?id=<?php echo $id ?>"><span><b>MEDICINE LIST</b></span></a>
   <a href="delivery_list.php?id=<?php echo $id ?>"><span><b> Health Articles </b></span></a>
...
<h2> MEDICINE Ex.date: </h2> 
<input type="text" name="price" placeholder = "medicine Expire date.." onkeyup="check_price(this)"> <a id="price_msg"></a>
